<?php $__env->startSection('header_title', 'Security Operations Center (SOC) Terminal'); ?>
...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="glass-panel p-6 rounded-2xl relative overflow-hidden flex flex-col justify-between h-32">
            ...
            <div class="mt-2">
                <h2 class="text-3xl font-extrabold tracking-tight text-slate-100 font-mono"><?php echo e(number_format($totalAnalyzedEntries)); ?></h2>
        ...
        <div class="glass-panel p-6 rounded-2xl relative overflow-hidden flex flex-col justify-between h-32">
            ...
            <div class="mt-2">
                <h2 class="text-3xl font-extrabold tracking-tight text-red-400 font-mono"><?php echo e(number_format($totalFindings)); ?></h2>
        ...
        <div class="glass-panel p-6 rounded-2xl relative overflow-hidden flex flex-col justify-between h-32">
            ...
            <div class="mt-2">
                <h2 class="text-3xl font-extrabold tracking-tight text-purple-400 font-mono"><?php echo e($avgZeroDayRate); ?>%</h2>
        ...
        <div class="glass-panel p-6 rounded-2xl relative overflow-hidden flex flex-col justify-between h-32">
            ...
            <div class="mt-2">
                <h2 class="text-3xl font-extrabold tracking-tight text-emerald-400 font-mono"><?php echo e($avgAccuracy); ?>%</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="glass-panel p-6 rounded-2xl flex flex-col justify-between h-[450px]">
            ...
            <form method="POST" action="<?php echo e(route('log.upload')); ?>" enctype="multipart/form-data" class="flex-1 flex flex-col justify-between">
                <?php echo csrf_field(); ?>
    ...
    <div class="glass-panel rounded-2xl overflow-hidden shadow-xl">
        <div class="p-6 border-b border-slate-800 flex items-center justify-between">
            ...
            <span class="text-xs text-slate-500 font-mono">Page: <?php echo e($analyses->currentPage()); ?> of <?php echo e($analyses->lastPage()); ?></span>
        </div>
                        ...
                        <tr class="hover:bg-slate-900/20 transition duration-150">
                            <td class="px-6 py-4 font-semibold text-slate-200">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="truncate max-w-[200px]" title="<?php echo e($analysis->log->file_name); ?>"><?php echo e($analysis->log->file_name); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 font-medium text-slate-400">
                                <?php echo e($analysis->log->user->name); ?>

                            </td>
                            <td class="px-6 py-4 text-center font-mono font-semibold">
                                <?php echo e(number_format($analysis->total_entries)); ?>

                            </td>
                            <td class="px-6 py-4 text-center">
                                <?php if($analysis->total_findings > 0): ?>
                                    <span class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-red-500/10 text-red-400 border border-red-500/20">
                                        <?php echo e($analysis->total_findings); ?> alerts
                                    </span>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 text-center font-mono text-purple-400 font-bold">
                                <?php echo e($analysis->zero_day_rate); ?>%
                            </td>
                            <td class="px-6 py-4 text-center font-mono text-emerald-400 font-bold">
                                <?php echo e(round($analysis->accuracy * 100, 1)); ?>%
                            </td>
                            <td class="px-6 py-4 font-mono text-xs text-slate-400">
                                <?php echo e($analysis->created_at->format('Y-m-d H:i:s')); ?>

                            </td>
                            <td class="px-6 py-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    <a href="<?php echo e(route('analysis.show', $analysis)); ?>" class="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-slate-200 rounded-lg transition duration-150 border border-slate-700">
                                        <i class="fa-solid fa-eye mr-1"></i> Inspect
                                    </a>
                                    <a href="<?php echo e(route('analysis.pdf', $analysis)); ?>" class="px-3 py-1.5 bg-red-600/10 hover:bg-red-600/20 text-xs font-semibold text-red-400 rounded-lg transition duration-150 border border-red-500/20">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const timelineData = <?php echo json_encode($timelineData, 15, 512) ?>;
        ...
        const attackTypes = <?php echo json_encode($attackTypes, 15, 512) ?>;
        ...
        const topIps = <?php echo json_encode($topIps, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moza1\Desktop\project1.final\resources\views/dashboard.blade.php ENDPATH**/ ?>