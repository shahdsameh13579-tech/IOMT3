...
<body class="h-full flex items-center justify-center p-6">
    <div class="w-full max-w-md glass-panel p-8 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-slate-800">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select id="role" name="role" required
                        ...
                        <option value="analyst" <?php echo e(old('role') === 'analyst' ? 'selected' : ''); ?>>Analyst (Standard access)</option>
                        <option value="admin" <?php echo e(old('role') === 'admin' ? 'selected' : ''); ?>>Admin (Full policy control)</option>
                    </select>
        ...
        <div class="mt-6 text-center text-xs text-slate-500">
            Have clearance already? <a href="<?php echo e(route('login')); ?>" class="text-red-400 hover:text-red-300 font-semibold underline underline-offset-4">Log in here</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\moza1\Desktop\project1.final\resources\views/auth/register.blade.php ENDPATH**/ ?>